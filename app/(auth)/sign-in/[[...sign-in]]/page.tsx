            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <h1 className="text-3xl font-bold leading-tight tracking-tight text-white">
                  Welcome back to your pro media workspace.
                </h1>
                <p className="max-w-md text-base leading-relaxed text-neutral-400">
                  Continue uploading videos, generating social-ready assets, and
              ...
              <div className="flex items-start gap-4 rounded-xl border border-white/10 bg-black/40 p-5 backdrop-blur-md">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-neutral-400">
                    Clerk authentication keeps all dashboard actions protected.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4 rounded-xl border border-white/10 bg-black/40 p-5 backdrop-blur-md">
                ...
                <div>
                  <p className="font-semibold text-white">Paid tier experience</p>
                  <p className="mt-1 text-sm leading-relaxed text-neutral-400">
                    Freemium trial is for guests. Signed users continue with premium workflow access.
                  </p>
                </div>
              </div>
            </div>
